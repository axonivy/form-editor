...
describe('modifyData', () => {
  ...
  describe('drag and drop', () => {
    ...
    test('add deep', () => {
      ...
      data = modifyData(data, {
        type: 'dnd',
        data: { activeId: 'Button', targetId: `layout-${data.components[0].cid}`, componentByName }
      }).newData;
      data = modifyData(data, {
        type: 'dnd',
        data: { activeId: 'Text', targetId: `layout-${data.components[0].cid}`, componentByName }
      }).newData;
      expect(data).to.not.deep.equals(emptyData());
      expect(data.components).to.have.length(1);
  ...
  describe('add', () => {
    test('normal', () => {
      const data = modifyData(emptyData(), {
        type: 'add',
        data: { componentName: 'Input', create: { label: 'Age', value: 'age' }, componentByName }
      }).newData;
    ...
    test('add to structure', () => {
      const data = modifyData(filledData(), {
        type: 'add',
        data: { componentName: 'Input', create: { label: 'Age', value: 'age' }, targetId: '31', componentByName }
      }).newData;
    ...
    test('add to datatable is not possible', () => {
      const data = modifyData(tableData(), {
        type: 'add',
        data: { componentName: 'Input', create: { label: 'Age', value: 'age' }, targetId: '11', componentByName }
      }).newData;
  ...
  describe('paste', () => {
    test('duplicate', () => {
      ...
      const data = modifyData(filledData(), {
        type: 'paste',
        data: { componentName: copy.type, clipboard: copy.config, targetId: '1', componentByName }
      }).newData;
      expect(data).not.toEqual(filledData());
    ...
    test('paste', () => {
      ...
      const data = modifyData(filledData(), {
        type: 'paste',
        data: { componentName: copy.type, clipboard: copy.config, targetId: '4', componentByName }
      }).newData;
      expect(data).not.toEqual(filledData());
      expect(data.components).toHaveLength(6);
    ...
    test('paste datatable column', () => {
      ...
      const data = modifyData(tableData(), {
        type: 'paste',
        data: { componentName: copy.type, clipboard: copy.config, targetId: '11', componentByName }
      }).newData;
    ...
    test('paste datatable action column', () => {
      ...
      const data = modifyData(tableData(), {
        type: 'paste',
        data: { componentName: copy.type, clipboard: copy.config, targetId: '13', componentByName }
      }).newData;
      expect(data).not.toEqual(tableData());
      expect(data.components).toHaveLength(1);
      const component = data.components.find(c => c.cid === '1') as TableConfig;
    ...
    test('paste other things into datatable is not possible', () => {
      ...
      const data = modifyData(originalData, {
        type: 'paste',
        data: { componentName: 'Button', clipboard: {}, targetId: '11', componentByName }
      }).newData;
    ...
    test('duplicate deep', () => {
      ...
      const data = modifyData(filledData(), {
        type: 'paste',
        data: { componentName: copy.type, clipboard: copy.config, targetId: '31', componentByName }
      }).newData;
    ...
    test('duplicate layout', () => {
      ...
      const data = modifyData(filledData(), {
        type: 'paste',
        data: { componentName: copy.type, clipboard: copy.config, targetId: '3', componentByName }
      }).newData;
      expect(data.components).toHaveLength(6);
